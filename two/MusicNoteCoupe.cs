...
public class MusicNoteCoupe : GameMode
{
    ...
    void Start ()
	{
	    musicNote =  Resources.Load("UI/Coupe/redMonster") as GameObject;//获取音符
        target = gameObject.transform.Find("end_redMonster").GetComponent<Image>();
        start = gameObject.transform.Find("start_redMonster").GetComponent<Image>();
    ...
    void TimeSpace()//第一种音符间隔时间
    {
        ...
        timeSpace = Random.Range(1.1f, 3.1f);
    }
